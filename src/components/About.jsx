...
function About () {
	...
	return (
		<section className='flex h-[400px]  justify-center sm:mx-16 min-h-[900px] '>
			<div className='flex flex-col-reverse sm:flex flex-col sm:flex-row h-full justify-between align-middle items-center'>
				<div className='w-[80%] sm:w-[60%] sm:ml-10 text-white'>
				...
				<img
					className='h-96 rounded-full opacity-70 transition-[1s] hover:opacity-100 shadow-[#588E91] shadow-lg mt-5 mb-16 sm:mb-0 mx-auto'
					src={test}
					alt='BrunoPic'
				/>
			</div>
